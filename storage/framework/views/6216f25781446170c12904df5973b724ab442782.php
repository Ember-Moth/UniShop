...
<?php if($builder->visible($item)): ?>
    <?php if(empty($item['children'])): ?>
        <li class="nav-item">
            <a <?php if(mb_strpos($item['uri'], '://') !== false): ?> target="_blank" <?php endif; ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH D:\phpstudy_pro\WWW\UniShop\vendor\dcat\laravel-admin\src/../resources/views/partials/menu.blade.php ENDPATH**/ ?>