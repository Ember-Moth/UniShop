                                                    ...
                                                    @endif
                                                        <div class="col-12">
                                                            <fieldset>
                                                                ...
                                                                <select name="payway" id="" class="form-control form-control-sm" style="width: 80%">
                                                                    <option value="0">{{ __('dujiaoka.payment_method') }}</option>
                                                                @foreach($payways as $index => $way)
                                                                        <option value="{{ $way->id }}" @if($index == 0) selected @endif>{{ $way->name }}</option>
                                                                @endforeach
                                                                </select>
                                                            </fieldset>
                                                        </div>
